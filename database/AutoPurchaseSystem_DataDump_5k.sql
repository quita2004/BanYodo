...
-- =====================================
INSERT INTO T_LICENSE_ASSIGNMENTS (ASSIGNMENT_ID, LICENSE_ID, CLIENT_ID, IS_LOGGED_IN, LAST_LOGIN_AT, ASSIGNED_AT)
SELECT NEWID(), L.LICENSE_ID, C.CLIENT_ID, 0, NULL, GETDATE()
